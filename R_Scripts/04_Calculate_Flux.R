...
################################## 2018 #########################################
FRCH_chem_2018 <- read.csv("~/Documents/Storms/Q_Chem/FRCH/FRCH_chem_2018.csv")
MOOS_chem_2018 <- read_csv("~/Documents/Storms/Q_Chem/MOOS/MOOS_chem_2018.csv")
FRCH_chem_2018 <- read.csv("~/Documents/Storms/Q_Chem/FRCH/FRCH_chem_2018.csv")
FRCH_chem_2018$DateTime <- ymd_hms(FRCH_chem_2018$DateTime)
...
# DOD Sites #
MOOS_chem_2018$H20_yield_km2 <- MOOS_chem_2018$MeanDischarge/113 #MOOS is 113km^2
FRCH_chem_2018$H20_yield_km2 <- FRCH_chem_2018$MeanDischarge/44 #FRCHis 44km^2
names(FRCH_chem_2018)[1] <- "X1"

h20.yield.2018 <- rbind(FRCH_chem_2018, MOOS_chem_2018)
h20.yield$day <- date(h20.yield$DateTime) # make a day column
h20.daily.means <- aggregate(x=h20.yield$H20_yield_km2,
                             by=list(h20.yield$Site,h20.yield$day),
                             FUN=mean, na.rm = TRUE)
names(h20.daily.means) <- c("Site", "DateTime", "H20_yield_km2")

ggplot(h20.daily.means, aes(Site, H20_yield_km2)) + geom_boxplot(aes(fill=Site))+
...
########################################## 2019 ##########################
FRCH_chem_2019 <- read.csv("~/Documents/Storms/Q_Chem/FRCH/FRCH_chem_2019.csv")
MOOS_chem_2019 <- read_csv("~/Documents/Storms/Q_Chem/MOOS/MOOS_chem_2019.csv")
POKE_chem_2019 <- read.csv("~/Documents/Storms/Q_Chem/POKE/POKE_chem_2019.csv")
VAUL_chem_2019 <- read_csv("~/Documents/Storms/Q_Chem/VAUL/VAUL_chem_2019.csv")
STRT_chem_2019 <- read.csv("~/Documents/Storms/Q_Chem/STRT/STRT_chem_2019.csv")


# convert to datetime ak #
FRCH_chem_2019$DateTime <- ymd_hms(FRCH_chem_2019$DateTime)
attributes(FRCH_chem_2019$DateTime)$tzone <- 'America/Anchorage'
MOOS_chem_2019$DateTime <- ymd_hms(MOOS_chem_2019$DateTime)
attributes(MOOS_chem_2019$DateTime)$tzone <- 'America/Anchorage'
POKE_chem_2019$DateTime <- ymd_hms(POKE_chem_2019$DateTime)
attributes(POKE_chem_2019$DateTime)$tzone <- 'America/Anchorage'
VAUL_chem_2019$DateTime <- ymd_hms(VAUL_chem_2019$DateTime)
attributes(VAUL_chem_2019$DateTime)$tzone <- 'America/Anchorage'
STRT_chem_2019$DateTime <- ymd_hms(STRT_chem_2019$DateTime)
attributes(STRT_chem_2019$DateTime)$tzone <- 'America/Anchorage'

# Making the same time frame # 
FRCH_chem_2019 <- subset(FRCH_chem_2019, FRCH_chem_2019$DateTime > "2019-06-19" & FRCH_chem_2019$DateTime < "2019-10-09")
MOOS_chem_2019 <- subset(MOOS_chem_2019, MOOS_chem_2019$DateTime > "2019-06-19" & MOOS_chem_2019$DateTime < "2019-10-09")
POKE_chem_2019 <- subset(POKE_chem_2019, POKE_chem_2019$DateTime > "2019-06-19" & POKE_chem_2019$DateTime < "2019-10-09")
VAUL_chem_2019 <- subset(VAUL_chem_2019, VAUL_chem_2019$DateTime > "2019-06-19" & VAUL_chem_2019$DateTime < "2019-10-09")
STRT_chem_2019 <- subset(STRT_chem_2019, STRT_chem_2019$DateTime > "2019-06-19" & STRT_chem_2019$DateTime < "2019-10-09")

# DOD Sites #
MOOS_chem_2019$H20_yield_km2 <- MOOS_chem_2019$MeanDischarge/113 #MOOS is 113km^2
FRCH_chem_2019$H20_yield_km2 <- FRCH_chem_2019$MeanDischarge/44 #FRCHis 44km^2
POKE_chem_2019$H20_yield_km2 <- POKE_chem_2019$MeanDischarge/60 #FRCHis 44km^2
VAUL_chem_2019$H20_yield_km2 <- VAUL_chem_2019$MeanDischarge/32 #FRCHis 44km^2
STRT_chem_2019$H20_yield_km2 <- STRT_chem_2019$MeanDischarge/125 #FRCHis 44km^2

# remove unnecessary columns and rename to join #
MOOS_chem_2019 <- MOOS_chem_2019[,-c(1)]
names(VAUL_chem_2019)[1] <- "X"

h20.yield.2019 <- rbind(FRCH_chem_2019, MOOS_chem_2019, POKE_chem_2019, VAUL_chem_2019, STRT_chem_2019)
h20.yield$day <- date(h20.yield$DateTime) # make a day column
h20.daily.means <- aggregate(x=h20.yield$H20_yield_km2,
                             by=list(h20.yield$Site,h20.yield$day),
                             FUN=mean, na.rm = TRUE)
...
ggplot(h20.daily.means, aes(Site, H20_yield_km2)) + geom_boxplot(aes(fill=Site))+
  scale_fill_manual(values=c("#0571B0","#92C5DE","#F4A582", "#CA0020", "yellow"), "Catchment") +
  theme_bw() + ylab("H20- daily mean yield (L/km2/day)") + xlab("") + 
  theme(panel.border = element_blank(), panel.grid.major = element_blank(),panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), text = element_text(size = 20), legend.position = "none") +
  ggtitle("2019")

########################################## 2020 ##########################
FRCH_chem_2020 <- read.csv("~/Documents/Storms/Q_Chem/FRCH/FRCH_chem_2020.csv")
MOOS_chem_2020 <- read_csv("~/Documents/Storms/Q_Chem/MOOS/MOOS_chem_2020.csv")
POKE_chem_2020 <- read.csv("~/Documents/Storms/Q_Chem/POKE/POKE_chem_2020.csv")
VAUL_chem_2020 <- read_csv("~/Documents/Storms/Q_Chem/VAUL/VAUL_chem_2020.csv")
STRT_chem_2020 <- read.csv("~/Documents/Storms/Q_Chem/STRT/STRT_chem_2020.csv")

# convert to datetime ak #
FRCH_chem_2020$DateTime <- ymd_hms(FRCH_chem_2020$DateTime)
attributes(FRCH_chem_2020$DateTime)$tzone <- 'America/Anchorage'
MOOS_chem_2020$DateTime <- ymd_hms(MOOS_chem_2020$DateTime)
attributes(MOOS_chem_2020$DateTime)$tzone <- 'America/Anchorage'
POKE_chem_2020$DateTime <- ymd_hms(POKE_chem_2020$DateTime)
attributes(POKE_chem_2020$DateTime)$tzone <- 'America/Anchorage'
VAUL_chem_2020$DateTime <- ymd_hms(VAUL_chem_2020$DateTime)
attributes(VAUL_chem_2019$DateTime)$tzone <- 'America/Anchorage'
STRT_chem_2020$DateTime <- ymd_hms(STRT_chem_2020$DateTime)
...
# DOD Sites #
MOOS_chem_2020$H20_yield_km2 <- MOOS_chem_2020$MeanDischarge/113 #MOOS is 113km^2
FRCH_chem_2020$H20_yield_km2 <- FRCH_chem_2020$MeanDischarge/44 #FRCHis 44km^2
POKE_chem_2020$H20_yield_km2 <- POKE_chem_2020$MeanDischarge/60 #FRCHis 44km^2
VAUL_chem_2020$H20_yield_km2 <- VAUL_chem_2020$MeanDischarge/32 #FRCHis 44km^2
STRT_chem_2020$H20_yield_km2 <- STRT_chem_2020$MeanDischarge/125 #FRCHis 44km^2

# remove unnecessary columns and rename to join #
MOOS_chem_2020 <- MOOS_chem_2020[,-c(1)]
names(VAUL_chem_2020)[1] <- "X"
names(POKE_chem_2020)[6] <- "fDOM.QSU"

h20.yield.2020 <- rbind(FRCH_chem_2020, MOOS_chem_2020, POKE_chem_2020, VAUL_chem_2020, STRT_chem_2020)
...
##################################### ALL YEARS ###############################################
# making them all the same name and merging #
names(FRCH_chem_2018)[1] <- "X"
names(MOOS_chem_2018)[1] <- "X"
FRCH_chem_2018$day <- as.Date(FRCH_chem_2018$DateTime)
MOOS_chem_2018$day <- as.Date(MOOS_chem_2018$DateTime)
FRCH_chem_2018$year <- "2018"
MOOS_chem_2018$year <- "2018"

h20.yield.2018 <- rbind(FRCH_chem_2018, MOOS_chem_2018)

names(FRCH_chem_2019) <- c("X", "Site", "DateTime", "MeanDischarge", "day", "fDOM.QSU", "nitrateuM", "SpCond.uScm",
                           "Turbidity.FNU", "H20_yield_km2")
names(MOOS_chem_2019) <- c("X", "Site", "DateTime", "MeanDischarge", "day", "fDOM.QSU", "nitrateuM", "SpCond.uScm",
                           "Turbidity.FNU", "H20_yield_km2")
names(POKE_chem_2019) <- c("X", "Site", "DateTime", "MeanDischarge", "day", "fDOM.QSU", "nitrateuM", "SpCond.uScm",
                           "Turbidity.FNU", "H20_yield_km2")
names(VAUL_chem_2019) <- c("X", "Site", "DateTime", "MeanDischarge", "day", "fDOM.QSU", "nitrateuM", "SpCond.uScm",
                           "Turbidity.FNU", "H20_yield_km2")
names(STRT_chem_2019) <- c("X", "Site", "DateTime", "MeanDischarge", "day", "fDOM.QSU", "nitrateuM", "SpCond.uScm",
                           "Turbidity.FNU", "H20_yield_km2")
FRCH_chem_2019$year <- "2019"
MOOS_chem_2019$year <- "2019"
POKE_chem_2019$year <- "2019"
VAUL_chem_2019$year <- "2019"
STRT_chem_2019$year <- "2019"

h20.yield.2019 <- rbind(FRCH_chem_2019, MOOS_chem_2019, POKE_chem_2019, VAUL_chem_2019, STRT_chem_2019)

FRCH_chem_2020$year <- "2020"
MOOS_chem_2020$year <- "2020"
POKE_chem_2020$year <- "2020"
VAUL_chem_2020$year <- "2020"
STRT_chem_2020$year <- "2020"

h20.yield.2020 <- rbind(FRCH_chem_2020, MOOS_chem_2020, POKE_chem_2020, VAUL_chem_2020, STRT_chem_2020)

h20.yield.total <- rbind(h20.yield.2018, h20.yield.2019, h20.yield.2020)
write.csv(h20.yield.total, "~/Documents/DoD_Discharge/Discharge_Chem/2018_2020_Q_chem_all.csv")

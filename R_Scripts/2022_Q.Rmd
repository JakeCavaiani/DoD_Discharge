...
ggplot(aes(x = difference, y = MeasuredQ_Ls), data = Stuart1comb.2022) +
  ...
  ggtitle("Stuart all measured Q")
```
The relationship is not strong at low Q.
...
vaul.stream.two.2022 %>% filter(DateTimeAK > "2022-10-10") %>% ggplot( aes(x = DateTimeAK, y = WaterPressure))+
  geom_point() +
  theme_classic()
...
# Plot air and water pressure
VAUL.2022 %>% filter(DateTimeAK > "2022-10-11") %>% ggplot(aes(DateTimeAK, WaterPressure)) + geom_point() + geom_point(aes(DateTimeAK, AirPressureCorrectedVAUL), color = "red")
```
...
# Plot air and water pressure
VAUL.2022.2 %>% ggplot(aes(DateTimeAK, WaterPressure)) + geom_point() + geom_point(aes(DateTimeAK, AirPressureCorrectedVAUL), color = "red")
```

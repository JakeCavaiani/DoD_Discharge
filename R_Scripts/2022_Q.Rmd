...
When there is a large gap, in an attempt to be systematic I will shift that points so that the difference between the water and air pressure within a day on each edge of the gap is the same. This probably overestimates the discharge after the gap.
...
```{r}
# Remove three high Q points points
Poker1comb.2022.2 <- Poker1comb.2022 %>% filter(MeasuredQ_Ls < 700)
### Rating Curve ###
poke.formula <- y ~ x

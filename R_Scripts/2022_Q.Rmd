...
What if we just use the above curve when the pressure difference is > 8 and the curve with the wading rod measurements and the 3 low YSI points when it is < 8?
...
Well that looks terrible. What if we average the predicted Q from both?

```{r, message = FALSE, warning = FALSE}
## Average the first predicted Q and the merged predicted Q
...
There is still a big drop in predicted Q. Is there any way to smooth it out any better than that, or is this a bad idea?

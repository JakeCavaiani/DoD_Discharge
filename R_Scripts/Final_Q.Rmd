...
```
1) middle of July gap is just connected 

### Export csv to DoD_Discharge->PT_data->2015
```{r , echo=FALSE, warning=FALSE}
...
write.csv(Q_2015, "~/Documents/DoD_Discharge/Predicted_Discharge/2015/Q_2015.csv", row.names = FALSE)

Q.daily.2015 = with(Q_2015, tapply(Q, list(day, Site), mean))
Q.daily.2015 = as.data.frame(Q.daily.2015)
write.csv(Q.daily.2015, "~/Documents/DoD_Discharge/Predicted_Discharge/2015/Q.daily.2015.csv", row.names = FALSE)
...
### export PT data to csv to DoD_Discharge->Prredicted_Discharge->2018
```{r, echo=FALSE, warning=FALSE}
...
write.csv(moos.stream.one.2019, "~/Documents/DoD_Discharge/PT_data/2019/MOOS/moos.pt.2019.csv", row.names = FALSE)
```
...
```{r, echo=FALSE, warning=FALSE}
Moose2comb.2019_final <- Moose2comb.2019[,-c(2:3,5:11)]
names(Moose2comb.2019_final) <- c("Site", "DateTime", "Q")
write.csv(Moose2comb.2019_final, "~/Documents/DoD_Discharge/Predicted_Discharge/2019/MOOS/MOOS.Q.csv", row.names = FALSE)
```
...
write.csv(frch.pt.2019.final, "~/Documents/DoD_Discharge/PT_data/2019/FRCH/frch.pt.2019.csv", row.names = FALSE)
```

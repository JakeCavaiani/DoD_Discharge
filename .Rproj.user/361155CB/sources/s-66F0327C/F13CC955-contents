...
#### load data ####
STRT_storm1a_06_19 <- read.csv("Storms/STRT_storm1a_06_19.csv", row.names = 1)
STRT_storm1a_06_19_Q <- read.csv("Storms/STRT_storm1a_06_19_Q.csv", row.names = 1)
STRT_storm1a_06_19_NO3 <- read.csv("Storms/STRT_storm1a_06_19_NO3.csv", row.names = 1)
STRT_storm1a_06_19_fDOM <- read.csv("Storms/STRT_storm1a_06_19_fDOM.csv", row.names = 1)

STRT_storm1b_06_20 <- read.csv("Storms/STRT_storm1b_06_20.csv", row.names = 1)
STRT_storm1b_06_20_Q <- read.csv("Storms/STRT_storm1b_06_20_Q.csv", row.names = 1)
STRT_storm1b_06_20_NO3 <- read.csv("Storms/STRT_storm1b_06_20_NO3.csv", row.names = 1)
STRT_storm1b_06_20_fDOM <- read.csv("Storms/STRT_storm1b_06_20_fDOM.csv", row.names = 1)

STRT_storm1c_06_22 <- read.csv("Storms/STRT_storm1c_06_22.csv", row.names = 1)
STRT_storm1c_06_22_Q <- read.csv("Storms/STRT_storm1c_06_22_Q.csv", row.names = 1)
STRT_storm1c_06_22_NO3 <- read.csv("Storms/STRT_storm1c_06_22_NO3.csv", row.names = 1)
STRT_storm1c_06_22_fDOM <- read.csv("Storms/STRT_storm1c_06_22_fDOM.csv", row.names = 1)

STRT_storm1d_06_23 <- read.csv("Storms/STRT_storm1d_06_23.csv", row.names = 1)
STRT_storm1d_06_23_Q <- read.csv("Storms/STRT_storm1d_06_23_Q.csv", row.names = 1)
STRT_storm1d_06_23_NO3 <- read.csv("Storms/STRT_storm1d_06_23_NO3.csv", row.names = 1)
STRT_storm1d_06_23_fDOM <- read.csv("Storms/STRT_storm1d_06_23_fDOM.csv", row.names = 1)

STRT_storm1e_06_24 <- read.csv("Storms/STRT_storm1e_06_24.csv", row.names = 1)
STRT_storm1e_06_24_Q <- read.csv("Storms/STRT_storm1e_06_24_Q.csv", row.names = 1)
STRT_storm1e_06_24_NO3 <- read.csv("Storms/STRT_storm1e_06_24_NO3.csv", row.names = 1)
STRT_storm1e_06_243_fDOM <- read.csv("Storms/STRT_storm1e_06_24_fDOM.csv", row.names = 1)

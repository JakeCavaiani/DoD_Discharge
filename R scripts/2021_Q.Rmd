...
strt.stream.one.2021.b %>% #filter(DateTime > "2021-07-02") %>% 
...
strt.stream.one.2021 <- strt.stream.one.2021 %>% mutate(across(c(WaterLevel), ~ifelse(DateTime <= "2021-06-28 11:00:00", WaterLevel + 0.47,. )))
...
strt.stream.two.2021 %>% filter(DateTime > "2021-08-02" & DateTime < "2021-08-04") %>% ggplot(aes(DateTime, WaterLevel)) + geom_point()

...
```{r, echo=FALSE, warning=FALSE}
# Add any missing time steps
DateTimeFill <- data.frame(DateTime = seq(ymd_hm("2021-06-30 03:00", tz = "America/Anchorage"),ymd_hm("2021-09-26 24:00", tz = "America/Anchorage"), by = '15 mins'))
...
DateTimeFill <- data.frame(DateTime = seq(ymd_hm("2021-05-04 09:00", tz = "America/Anchorage"),ymd_hm("2021-09-26 24:00", tz = "America/Anchorage"), by = '15 mins'))
...
Q_2021 %>% ggplot(aes(DateTime, Q, color = Site)) + geom_point(size = 0.25)
```

...
moos.final.discharge.2021_final <- na_kalman(moos.final.discharge.2021_final, maxgap = 50)
...
frch.final.discharge.2021_final <- na_kalman(frch.final.discharge.2021_final, maxgap = 50)
...
poke.final.discharge.2021_final <- na_kalman(poke.final.discharge.2021_final, maxgap = 50)
...
vaul.final.discharge.2021_final <- na_kalman(vaul.final.discharge.2021_final, maxgap = 50)
...
strt.final.discharge.2021_final <- na_kalman(strt.final.discharge.2021_final, maxgap = 50)
...
Q_2021_check_NA %>% filter(Site == "MOOS") %>%

...
DateTimeFill <- data.frame(DateTime = seq(ymd_hm("2021-05-04 09:00"),ymd_hm("2021-09-27 24:00"), by = '15 mins'))
...
moos.final.discharge.2021_final <- moos.final.discharge.2021[,-c(2:3)] %>% filter(DateTime >= "2021-05-04 09:00" & DateTime <= "2021-09-27 24:00")
...
## Export PT data to csv in DoD_Discharge->Predicted_discharge->2021
```{r, echo=FALSE, warning=FALSE}
frch.final.discharge.2021_final <- frch.final.discharge.2021[,c(7,5,12)]
...
```{r, echo=FALSE, warning=FALSE}
# Add any missing time steps
DateTimeFill <- data.frame(DateTime = seq(ymd_hm("2021-05-10 09:00"),ymd_hm("2021-09-27 08:15"), by = '15 mins'))
...
```{r, echo=FALSE, warning=FALSE}
# Add any missing time steps
DateTimeFill <- data.frame(DateTime = seq(ymd_hm("2021-05-04 09:00"),ymd_hm("2021-09-30 06:30"), by = '15 mins'))
strt.stream.one.2021 <- full_join(strt.stream.one.2021, DateTimeFill)
strt.stream.one.2021 <- na_kalman(strt.stream.one.2021, maxgap = 10)

# Add any missing time steps
DateTimeFill <- data.frame(DateTime = seq(ymd_hm("2021-05-19 09:00"),ymd_hm("2021-09-28 02:30"), by = '15 mins'))

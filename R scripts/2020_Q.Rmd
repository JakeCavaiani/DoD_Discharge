...
Moose1comb.2020.2 <- Moose1comb.2020[-c(13), ]
...
```{r, echo=FALSE, warning=FALSE}
MOOS1.lm.2020 <- lm(Moose1comb.2020.2$MeasuredQ_Ls ~ Moose1comb.2020.2$WaterLevel)

moos.stream.one.2020.final$pred.moos1.Q <- coef(MOOS1.lm.2020)[2] * moos.stream.one.2020.final$WaterLevel+ coef(MOOS1.lm.2020)[1] 
...
```{r, echo=FALSE, warning=FALSE}
MOOS2.lm.2020 <- lm(Moose2comb.2020.2$MeasuredQ_Ls ~ Moose2comb.2020.2$WaterLevel)


moos.stream.two.2020.final$pred.moos2.Q <- coef(MOOS2.lm.2020)[2] * moos.stream.two.2020.final$WaterLevel+ coef(MOOS2.lm.2020)[1]
...
```{r, echo=FALSE, warning=FALSE}
moos.final.discharge.2020 <- moos.final.discharge.2020 %>% mutate(across(c(MeanDischarge), ~ifelse(DateTime < "2020-07-01 16:00"  & DateTime > "2020-06-26 11:00", pred.moos1.Q,.)))
### Moose1 (light blue), Moose2 (dark blue), and mean (red) with observed Q.

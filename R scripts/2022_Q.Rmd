...
2022-05-01 00:00"),ymd_hm("2022-10-15 00:00"), by = '15 mins'))
...
DateTimeFill <- data.frame(DateTimeAK = seq(ymd_hm("2022-05-09 10:00"),ymd_hm("2022-10-10 16:00"), by = '15 mins'))
...
# Water pressure - atmospheric pressure 
DateTimeFill <- data.frame(DateTimeAK = seq(ymd_hm("	
2022-05-18 00:45"),ymd_hm("2022-10-04 06:00"), by = '15 mins'))

...
NEON_bp1 <- NEON_bp %>% filter(DateTimeAK > "2022-05-01" & DateTimeAK < "2022-06-01")
NEON_bp1$bp_sea <- na.approx(NEON_bp1$bp_sea, rule = 2)
NEON_bp1 %>% ggplot(aes(DateTimeAK, bp_sea)) + geom_point()

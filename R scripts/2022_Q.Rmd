...
moos.stream.two.2022 <- moos.stream.two.2022 %>%
  mutate(across(c(WaterPressure), 
                ~ifelse(DateTimeAK >= "2022-09-28 12:00" & DateTimeAK <= "2022-09-28 15:00" & WaterPressure > 100.9, NA, .)))
...
Q_2022 <- Q_2022 %>% group_by(Site) %>% summarise(Q = na_kalman(Q, maxgap = 10),
                                                  DateTimeAK = DateTimeAK) %>% filter(DateTimeAK < "2022-10-09")

...
2018-05-30 15:30", tz = "America/Anchorage"),ymd_hm("2018-10-12 10:00", tz = "America/Anchorage"), by = '15 mins'))
...
DateTimeFill <- data.frame(DateTime = seq(ymd_hm("	
2018-05-29 16:00", tz = "America/Anchorage"),ymd_hm("2018-10-26 15:03", tz = "America/Anchorage"), by = '15 mins'))
...
write.csv(French2comb, here("Predicted_Discharge/2018/FRCH/FRCH.Q.csv"), row.names = FALSE)
write.csv(moose3comb, here("Predicted_Discharge/2018/MOOS/MOOS.Q.csv"), row.names = FALSE)

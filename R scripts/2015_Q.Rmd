...
2015-05-20 22:15"),ymd_hm("2015-09-21 07:45"), by = '15 mins'))
...
```{r , echo=FALSE, warning=FALSE}
DateTimeFill <- data.frame(DateTimeAK = seq(ymd_hm("	
2015-05-18 15:15"),ymd_hm("2015-09-21 12:45"), by = '15 mins'))
...
pred_Q_2015 <- na_kalman(pred_Q_2015)
write.csv(pred_Q_2015, here("Predicted_Discharge/2015/Predicted_Q_2015.csv"))

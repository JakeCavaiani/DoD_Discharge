...
```{r, echo=FALSE, warning=FALSE}
French6comb.2019$pred.french1.Q <- coef(French6.lm.2019)[2] * French6comb.2019$AbsPTDepth+ coef(French6.lm.2019)[1]

p2 <- ggplot(aes(x = DateTime, y = pred.french1.Q), data=French6comb.2019) +
  geom_line(color="#A6CEE3", size=1.25) +
...
French7comb.2019 <- full_join(frch.stream.two.2019, QSummary.FR.2019.4) 
...
```{r, echo=FALSE, warning=FALSE}
French7comb.2019$pred.french1.Q <- coef(French7.lm.2019)[2] * French7comb.2019$AbsPTDepth+ coef(French7.lm.2019)[1]

p4 <- ggplot(aes(x = DateTime, y = pred.french1.Q), data=French7comb.2019) +
  geom_line(color="#A6CEE3", size=1.25) +
  geom_line(data = French6comb.2019, aes(DateTime, pred.french1.Q), color= "light green", size=1.25) +
  geom_point(data = French1comb.2019, aes(x = DateTime, y = Q_Ls, shape = Method), size=3) +
  theme_classic() +
  ggtitle("French") +
  scale_shape_discrete(name = "Method", labels = c("Wading Rod", "Salt Dilution", "")) +
...
p5 <- ggplot(aes(x = DateTime, y = pred.french1.Q), data=French7comb.2019) +
  geom_line(color="#A6CEE3", size=1.25) +
  geom_line(data = French6comb.2019, aes(DateTime, pred.french1.Q), color= "light green", size=1.25) +
  geom_point(data = French1comb.2019, aes(x = DateTime, y = Q_Ls, shape = Method), size=3) +
  theme_classic() +
...
write.csv(frch.final.discharge.2019.final, "~/Documents/DoD_Discharge/Predicted_Discharge/2019/FRCH/FRCH.Q.csv", row.names = FALSE)
```
...
write.csv(poke.pt.2019.final, "~/Documents/DoD_Discharge/PT_data/2019/POKE/poke.pt.2019.csv", row.names = FALSE)
```
...
write.csv(poke.final.discharge.2019.final, "~/Documents/DoD_Discharge/Predicted_Discharge/2019/POKE/POKE.Q.csv", row.names = FALSE)
```
...
### export PT data to csv to DoD_Discharge->PT_data->2019
```{r, echo=FALSE, warning=FALSE}
write.csv(vaul.stream.one.2019.1, "~/Documents/DoD_Discharge/PT_data/2019/VAUL/vaul.pt.2019.csv", row.names = FALSE)
```
...
write.csv(vaul.final.discharge.2019.final, "~/Documents/DoD_Discharge/Predicted_Discharge/2019/VAUL/VAUL.Q.csv", row.names = FALSE)
```
...
write.csv(strt.pt.final, "~/Documents/DoD_Discharge/PT_data/2019/STRT/strt.pt.2019.csv", row.names = FALSE)
```
...
write.csv(Stuart4comb.2019_final, "~/Documents/DoD_Discharge/Predicted_Discharge/2019/STRT/STRT.Q.csv", row.names = FALSE)
```
...
write_csv(Q_2019, "~/Documents/DoD_Discharge/Predicted_Discharge/2019/Q_2019.csv")

#Q_2019$DateTime = NULL

Q.daily.2019 = with(Q_2019, tapply(Q, list(day, Site), mean))
Q.daily.2019 = as.data.frame(Q.daily.2019)
write_csv(Q.daily.2019, "~/Documents/DoD_Discharge/Predicted_Discharge/2019/Q.daily.2019.csv")
```
...
write.csv(moos.pt.2020, "~/Documents/DoD_Discharge/PT_data/2020/MOOS/moos.pt.2020.csv")
```
...
```{r, echo=FALSE, warning=FALSE}
moos.final.discharge.2020_final <- moos.final.discharge.2020
names(moos.final.discharge.2020_final) <- c("Site", "DateTime", "Q")
write.csv(moos.final.discharge.2020_final, "~/Documents/DoD_Discharge/Predicted_Discharge/2020/MOOS/MOOS.Q.csv", row.names = FALSE)
```
...
write.csv(frch.pt.2020, "~/Documents/DoD_Discharge/PT_data/2020/FRCH/frch.pt.2020.csv")
```
...
write.csv(frch.final.discharge.2020_final, "~/Documents/DoD_Discharge/Predicted_Discharge/2020/FRCH/FRCH.Q.csv", row.names = FALSE)
```
...
write.csv(Poke1comb.2020_final, "~/Documents/DoD_Discharge/Predicted_Discharge/2020/POKE/POKE.Q.csv", row.names = FALSE)
```
...
## Export PT data to csv in DoD_Discharge->PT_data->2020
```{r, echo=FALSE, warning=FALSE}
write.csv(vaul.stream.2020, "~/Documents/DoD_Discharge/PT_data/2020/VAUL/vaul.pt.2020.csv", row.names = FALSE)
```
...
write.csv(Vaul2comb.2020_final, "~/Documents/DoD_Discharge/Predicted_Discharge/2020/VAUL/VAUL.Q.csv", row.names = FALSE)
```
...
write.csv(strt.final.discharge.2020_final, "~/Documents/DoD_Discharge/Predicted_Discharge/2020/STRT/STRT.Q.csv", row.names = FALSE)
```
...
write_csv(Q_2020, "~/Documents/DoD_Discharge/Predicted_Discharge/2020/Q_2020.csv")
write_csv(Q.daily.2020, "~/Documents/DoD_Discharge/Predicted_Discharge/2020/Q.daily.2020.csv")
...
write.csv(moos.pt.2021, "~/Documents/DoD_Discharge/PT_data/2021/MOOS/moos.pt.2021.csv", row.names = FALSE)
```
